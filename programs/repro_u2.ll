...
%ls.env.1 = type { i32 }
%ls.env.2 = type { i32 }
define i8* @unwrap_or__lsm173919979__ls_s0(i8* %_p2, i32 %d) {
entry:
  ...
  %_t12_codep = bitcast i32 (i8*, i8*)* @unwrap_or__lsm173919979__ls_s1 to i8*
  %_t12 = call i8* @ls_mkclos(i8* %_t12_codep, i8* %_t10)
  ret i8* %_t12
}

define i32 @unwrap_or__lsm173919979__ls_s1(i8* %_p1, i8* %o) {
entry:
  ...
  %_t9 = call i32 @unwrap_or__lsm173919979(i32 %_t8, i8* %o)
  ret i32 %_t9
}

define i32 @unwrap_or__lsm173919979(i32 %d, i8* %o) {
entry:
...
entry:
  ...
  store i32 42, i32* %_t13_bptr
  %_t14 = call i8* @ls_variant_mk(i32 1, i8* %_t13)
  %x = bitcast i8* %_t14 to i8*
  %_t15 = call i32 @unwrap_or__lsm173919979(i32 0, i8* %x)
  %_t16 = call i8* @ls_int_to_str(i32 %_t15)
  call void @ls_println(i8* %_t16)
  ret i32 0
}

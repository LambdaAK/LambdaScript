...
let length;
length = (function(lst) { return (() => { const _v1 = lst; if ((_v1?.type === 'nil')) {  return 0; } else { if ((_v1 instanceof Cons && (() => { const _v2 = _v1.head; const _v3 = _v1.tail; return true && true; })())) { const h = _v2; const t = _v3; return (1 + (length(t))); } else { throw new PatternMatchFailure(_v1); } } })(); });

const numbers = (new Cons(1, (new Cons(2, (new Cons(3, (new Cons(4, (new Cons(5, nil))))))))));

const len = (length(numbers));

(println((int_to_str(len))));